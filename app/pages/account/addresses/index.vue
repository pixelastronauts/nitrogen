...
const addresses = computed(
  () =>
    flattenConnection(customer.value?.addresses) as MailingAddressFragment[],
);

// Computed data
const defaultAddress = computed(
  () => customer.value?.defaultAddress as MailingAddressFragment,
);
...
<template>
  <section class="flex flex-col lg:col-span-2 2xl:col-span-1 mb-20">
    <div class="px-6 flex flex-col gap-6 lg:mt-6 lg:px-8">
      <h2 class="text-xl tracking-tight leading-none lg:p-0">Addresses</h2>
